...
/usr/lib64/mpich/bin/mpic++ -L/usr/lib64 -D MAX_NUMBER_OF_DEVICES_PER_PLATFORM=3 -D ALL_DEVICES  -O3 -o HIS_Estatico_ALL Balanceador.cpp OpenCLWrapper.cpp main.cpp -lOpenCL -lrt
