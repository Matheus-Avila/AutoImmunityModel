...
float Quimiotaxia(int celulaOffset, float *celulas, int xPosicaoGlobal, int yPosicaoGlobal, int zPosicaoGlobal, __constant int *parametrosMalhaGPU, float avgValue)
{	
...
void CalcularPontos(float *celulas, int xPosicaoGlobal, int yPosicaoGlobal, int zPosicaoGlobal, __constant int *parametrosMalhaGPU, __constant int *parametrosPosicaoBVTecido, __constant int *parametrosPosicaoPVTecido, __constant float *parametrosPopulacoesLinfonodo)
{
	...
	float microgliaChemotaxis = chi * Quimiotaxia(MICROGLIA_OFFSET, celulas, xPosicaoGlobal, yPosicaoGlobal, zPosicaoGlobal, parametrosMalhaGPU, avgMic);
	float conventionalDcChemotaxis = chi * Quimiotaxia(CONVENTIONAL_DC_OFFSET, celulas, xPosicaoGlobal, yPosicaoGlobal, zPosicaoGlobal, parametrosMalhaGPU, avgDc);
	float tCytotoxicChemotaxis = chi * Quimiotaxia(T_CYTOTOXIC_OFFSET, celulas, xPosicaoGlobal, yPosicaoGlobal, zPosicaoGlobal, parametrosMalhaGPU, avgT);
	//Microglia update
