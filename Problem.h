...
structParameters ParametersInitialize(){
    ...
    params.gammaT = 0.947922;//0.8885;//;//0.787852;//0.1;
    ...
    params.alphaTCytotoxic = 0.565958;//0.6178;//0.003970;//0.1;
    params.alphaB = 0.1;
    params.alphaP = 1;
    ...
    params.stableTCytotoxic = 27.6;//28.4;
    ...
    params.epslon_x = 0.971843;//0.99;//0.55;//0.95;//0.9944;//0.593797;//0.99; //0.1
...
class MSProblemTCytoParams : public pagmo::problem {
    public:
        ...
        std::vector<double> fitness(const vector_double& variables) const {
            ...
            float points[targetSize] = {27.6, 5.4, 8.6, 7.8, 8.2}; 
